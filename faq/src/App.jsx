  ...
  return (
    <div className="App">
      ...
      <div className="faq">
        <div className='question' onClick={() => setQuestion1(!question1)}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" fill="none" viewBox="0 0 30 31">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" fill="none" viewBox="0 0 30 31"><path fill="#301534" d="M15 3.313A12.187 
        ...
        {!question1 && <p>Frontend Mentor offers realistic coding challenges to help developers improve their
      ...
      <div className="faq">
        ...
        {!question2 && <p>Yes, Frontend Mentor offers both free and premium coding challenges, with the free
      ...
      <div className="faq">
        ...
        {!question3 && <p>Yes, you can use projects completed on Frontend Mentor in your portfolio. It's an excellent
      ...
      <div className="last">
        ...
        {!question4 && <p>The best place to get help is inside Frontend Mentor's Discord community. There's a help
